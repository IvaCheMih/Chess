...
func TestEndgame(t *testing.T) {
	...
	//
	//	fmt.Println(isEnd, endgameReason)
	//})
	...
	//t.Run("TestWhiteCheckMat", func(t *testing.T) {
	//	m := gameService.GetMoveService()
	//
	//	board := boardRepo.MakeBoardCells(1, makeWhiteCheckMatBoard())
	//
	//	var cells = map[int]*models.BoardCell{}
	//
	//	for i := range board {
...
func makeWhiteCheckMatBoard() [][]int {
	return [][]int{
